...
//check for filters$myfilter = "";
if(isset($_GET['filter'])) $myfilter = $_GET['filter'];
if ($myfilter == '1') {
...
//check order
$myOrder = "";if(isset($_GET['order'])) $myOrder = $_GET['order'];
if ($myOrder == 'SLH') {
...
?>
<div class="row">
<form role="form" method="POST" action="php/inventory_process.php">
	<div class="form-group tight-form-group" role="search">
		...
		<label for="order" class="col-md-1 col-form-label">Search Order</label>
